...
# fzf
export FZF_DEFAULT_OPTS="--height 60% --reverse --no-info --prompt='» ' --pointer='→' --color 'fg+:255:underline,hl:189,hl+:183,bg+:-1,marker:183,pointer:183,spinner:183,prompt:189:regular,query:189:regular:italic'"
