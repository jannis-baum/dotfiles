...
events.forEach((event) => {
    event.addListener(async () => {
        try {
            ...
            const pngs = await Promise.all(tabs.map((tab) => getPNGFavicon(tab['favIconUrl'])))
